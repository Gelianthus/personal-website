const projectObjects = [
	...
	{
		projId: "i2rw34ErthHYr",
		projTitle: "taylor-swift-lyrics",
		projType: "NPM Package",
		projDesc:
			"It creates a customizable React component of Taylor Swift's song's Lyrics",
		projDoc: [
			"Runs on commonJS type applications",
			"Custom styles can use both regular CSS and TailwindCSS.",
			"JS codes are transpiled with babel",
			"All TypeScript types are declared as 'any'",
		],
		projObjectives: [
			"Learn to create and publish an npm package",
			"Learn how compilers works",
			"Understanding package.json structure",
		],
		projLink: "https://www.npmjs.com/package/taylor-swift-lyrics",
		projStack: [
			{
				imgSrc: "/tech-stack-logos/react-logo.webp",
				imgAlt: "React logo",
		...
		projectImg: {
			imgSrc: "/personal-website-images/npm-logo.webp",
			imgAlt: "NPM logo",
		},
	},
